...
Three skills that run long loops on their own, each built around a hard rule that stops the usual "unattended agent" failure modes:
...
└── plugins/
    ...
    └── autonomous-workflows/    # /remediate, /harden-repos, /mine-provenance
```
